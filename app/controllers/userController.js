    ...
    let sendMail = (newUserObj) => {
        return new Promise((resolve, reject) => {
            ...
            const mailOptions = {
                ...
                html:'<a href="http://jyotivermprojects.info/verify/'+data.hash+'">http://jyotivermprojects.info'+data.hash+'</a>'
               };
...
let forgotPassword=(req,res)=>{
   ...
   const mailOptions = {
    ...
    html: "<p>Hi!,<br/>Please <a href='http://jyotivermprojects.info/changepassword/"+emailEncrypt+"'>Click here</a> to change your password!</p>"
